package com.rongcom.newsapp.ui.pagination
...
import com.rongcom.newsapp.data.model.topheadlines.ApiSource
...
fun PaginationTopHeadlineRoute(
    ...
    val topHeadlineUiState = topHeadlinePaginationViewModel.topHeadlineUiState.collectAsLazyPagingItems()
...
@Composable
fun TopHeadlineScreen(articles: LazyPagingItems<ApiTopHeadlines>, onNewsClick: (url: String) -> Unit) {
...
@Composable
fun ArticleList(articles: LazyPagingItems<ApiTopHeadlines>, onNewsClick: (url: String) -> Unit) {
    LazyColumn {
...
@Composable
fun ApiArticle(article: ApiTopHeadlines, onNewsClick: (url: String) -> Unit) {
...
@Composable
fun BannerImage(article: ApiTopHeadlines) {
    AsyncImage(
